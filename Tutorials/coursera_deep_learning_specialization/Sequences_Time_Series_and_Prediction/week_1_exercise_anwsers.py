...
def moving_average_forecast(series, window_size):
  ...
  # YOUR CODE HERE
  forecasts = []
  for point in range(len(series) - split_time):
      train = series[:split_time + point]
      forecast_value = np.mean(train[-window_size:])
      forecasts.append(forecast_value)
  return forecasts

moving_avg = moving_average_forecast(series, 30)# YOUR CODE HERE)[# YOUR CODE HERE]
