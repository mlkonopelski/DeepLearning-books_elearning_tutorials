...
Original file is located at
    https://colab.research.google.com/drive/1zD_GqTkUQfMz7s6v66OJqW3t_VeojJlW
"""
...
categories = len(list(set(labels)))
...
label_tokenizer = Tokenizer(6) # YOUR CODE HERE
